...
* [Fragment](android-java/fragment.md)
* [Fragment Image Viewer](android-java/fragment-image-viewer.md)
* [ActionBar](android-java/actionbar.md)
...
* [Thread](android-java/thread.md)
* [AsyncTask](android-java/asynctask.md)
* [Socket](android-java/socket.md)
* [HTTP](android-java/http.md)
* [Request To Web](android-java/request-to-web.md)
* [Volley](android-java/volley.md)
...
* [DataBase, SQL](android-java/database-sql.md)
* [DataBase, Table](android-java/database-table.md)
* [DataBase, INSERT, SELECT](android-java/database-insert-select.md)
* [DataBase , Helper](android-java/database-helper.md)
* [ConnectivityManager, NetworkInfo](android-java/connectivitymanager-networkinfo.md)
* [Camera](android-java/camera.md)
* [Mediaplayer](android-java/mediaplayer.md)
* [VideoView, MediaController](android-java/videoview-mediacontroller.md)
* [MediaRecorder](android-java/mediarecorder.md)
* [RecyclerView](android-java/recyclerview.md)
...
## Xamarin Android-C\# <a id="xamarin-android-csharp"></a>

* [Oreo 이상 버전에서 서비스를 사용하는법](xamarin-android-csharp/untitled.md)
* [Audio 볼륨 제어](xamarin-android-csharp/audio.md)

## Xamarin Forms - C\# <a id="xamarin-forms-csharp"></a>
